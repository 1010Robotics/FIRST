...
public class Robot extends TimedRobot {
  ...
  static private double WHEEL_DIAMETER = 0.157;
  static private double ENCODER_PULSE_PER_REV = 4048;
  ...
  public void robotInit() {
    ...
    WPI_VictorSPX leftSlave0 = new WPI_VictorSPX(7);
    leftSlave0.setInverted(false);
    leftSlave0.follow(leftMaster);
    leftSlave0.setNeutralMode(NeutralMode.Brake);
    WPI_VictorSPX leftSlave1 = new WPI_VictorSPX(12);
    leftSlave1.setInverted(false);
    leftSlave1.follow(leftMaster);
    leftSlave1.setNeutralMode(NeutralMode.Brake);

    WPI_VictorSPX rightSlave0 = new WPI_VictorSPX(8);
    rightSlave0.setInverted(false);
    rightSlave0.follow(rightMaster);
    rightSlave0.setNeutralMode(NeutralMode.Brake);
    WPI_VictorSPX rightSlave1 = new WPI_VictorSPX(11);
