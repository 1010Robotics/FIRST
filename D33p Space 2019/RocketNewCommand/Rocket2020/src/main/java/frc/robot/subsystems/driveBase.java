...
public class driveBase extends SubsystemBase {
  ...
  public driveBase() {
		...
		//Define Motors
		leftMotorF = new VictorSPX(Constants.RobotMap.LEFT_MOTORF.value);
		leftMotorF2 = new VictorSPX(Constants.RobotMap.LEFT_MOTORF2.value);
		leftMotor = new TalonSRX(Constants.RobotMap.LEFT_MOTOR.value);
		rightMotorF = new VictorSPX(Constants.RobotMap.RIGHT_MOTORF.value);
		rightMotorF2 = new VictorSPX(Constants.RobotMap.RIGHT_MOTORF2.value);
		rightMotor = new TalonSRX(Constants.RobotMap.RIGHT_MOTOR.value);
