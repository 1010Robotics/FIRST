...
<<<<<<< HEAD
  ...
  public int INTAKE_BALL = 4000; //preset for cargo
=======
  public int INTAKE_HATCH = 5750;//6100; //preset for intake (and default position)
  public int INTAKE_BALL = 3350;//3800; //preset for cargo
